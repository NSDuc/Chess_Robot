...
train_red = datagen.flow_from_directory('data_red_general/train/', target_size=(90, 90), color_mode='grayscale', class_mode='categorical', batch_size=128)
# Load and iterate validation dataset
val_red = datagen.flow_from_directory('data_red_general/validation/', target_size=(90, 90), color_mode='grayscale', class_mode='categorical', batch_size=128)
# Load and iterate test dataset
test_red = datagen.flow_from_directory('data_red_general/test/', target_size=(90, 90), color_mode='grayscale', class_mode='categorical', batch_size=128)
...
model_red.add(Dense(4, activation='softmax'))
...
model_red.save("model_red2.h5")
print("Saved model to disk")
del model_red

# Check the model results on the test set
# load model
model_red = load_model('model_red2.h5')
model_red.compile(optimizer='rmsprop', loss='categorical_crossentropy', metrics=['accuracy'])
# summarize model.
# model_red.summary()
...
X = cv2.imread('data_red_general/test/Elephant/r11.jpg', 0);

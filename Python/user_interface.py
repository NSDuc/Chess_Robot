...
class MainWindow(QMainWindow):
    ...
    def robot_work(self):
        ...
        for j in range(L):
            ...
            print("curt_tag=", curt_tag)
            print("prior[curt_tag,8]=", prior[curt_tag, 8])
            ...
            self.currentj1, self.currentj36 = robot_arm.robot_clamp2(robot_serial, matlab_serial,
                                                                     chess[sortidx[j], 0], chess[sortidx[j], 1],
                                                                     chess[sortidx[j], 2], chess[sortidx[j], 4],
            ...
            self.currentj1, self.currentj36 = robot_arm.robot_place2(robot_serial, matlab_serial,
                                                                     robo_tag[j, 0], robo_tag[j, 1], robo_tag[j, 2],
                                                                     robo_tag[j, 3], robo_tag[j, 4], self.currentj1,
                                                                     self.currentj36)
            prior[tag, 8] = check
